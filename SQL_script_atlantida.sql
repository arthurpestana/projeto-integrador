...
CREATE DATABASE IF NOT EXISTS atlantida_system DEFAULT CHARACTER SET utf8 default collate utf8_general_ci;
...
CREATE TABLE IF NOT EXISTS atlantida_system.tipo_cadastro (
  id_tipo_cadastro INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS atlantida_system.cliente (
  ...
  cadastro_geral_id_cadastro_geral INT NOT NULL,
  tipo_cadastro_id_tipo_cadastro INT NOT NULL,
...
-- -----------------------------------------------------
-- Tabela CADASTRO_GERAL
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS atlantida_system.cadastro_geral (
  id_cadastro_geral INT NOT NULL AUTO_INCREMENT,
  cod_tipo_cadastro INT NOT NULL,
...
-- NESTA TABELA SERÃO ADICIONADOS OS CLIENTES CONFORME OS CADASTROS

insert into cliente values (1, 'Paulo', '404 NORTE ALAMEDA 3 LOTE 06', 'PLANO DIRETOR NORTE', '77006-000', '60378', '6332327654', '6328765445', 'paulo@gmail.com', '0','0','0');


-- Inserção de Dados na Tabela usuario deve ser feita com a dinâmica do php, de acordo com a entrada dos usuários **(utilizar padrão de criptografia md5)
-- exemplo, e 1º usuário: 

insert into usuario (`id_user`,`user_nome`,`user_login`,`user_senha`,`email`,`ativo_inativo`) values
(1, 'Fulano', 'fulano', md5('123456'), 'fulano@gmail.com', 1);

-- Inserção de Dados na Tabela cadastro_geral

insert into cadastro_geral (`id_cadastro_geral`,`cod_tipo_cadastro`,`titulo`,`autores`,`cod_editora`,`edicao`,`ano`,`codigo_barras`,`num_isbn`,`cod_cidade`,
...
(1, 1, 'Fundamentos de Radiologia', 'Marcelo Felisberto', 1, '1', '2014', '1185007', '970631', '2', 'Português', '0', '1', 'Especialidades Médicas', 'Radiologia Médica', 'Volume único', '0', 'Como pesquisador e profissional da área de radiologia, o autor reuniu neste guia um grande número de imagens anatômicas e posições radiográficas, explicando-as em linguagem clara e acessível, além de demonstrar passo a passo a execução de todos os procedimentos, com objetivo de auxiliar estudantes e professores.
